...
class TorchSpyreModelRunner(GPUModelRunner):
    ...
    def initialize_kv_cache_tensors(self, kv_cache_config, kernel_block_sizes):
        ...
        is a single tensor matching SpyreAttentionBackend.get_kv_cache_shape:
          - NHD: [num_blocks, block_size, num_kv_heads, head_size]
          - HND: [num_blocks, num_kv_heads, block_size, head_size]
        The attention kernel selects a page by indexing with a one-element
        device tensor, so the page read is a real indirect access.
        """
